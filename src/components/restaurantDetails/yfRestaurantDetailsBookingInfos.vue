...
<style scoped>
.card-material-body-content .form {
  margin: 20px 20px;
}

.card-material .card-material-content .card-material-body-content .form h3 {
  margin-bottom: 10px;
}

.card-material .card-material-content .card-material-body-content .form input {
  border-radius: 10px;
  height: 20px;
  width: 190px;
...
.card-material .card-material-content .card-material-body-content .form select {
  height: 26px;
  width: 200px;
  border-radius: 10px;
  box-shadow: rgba(255, 255, 255, 0.2) 0px 0px 0px 1px inset, rgba(0, 0, 0, 0.9) 0px 0px 0px 1px;
...
.card-material .card-material-content .card-material-body-content .bottom {
  margin-top: 25px;
}

@media screen and (max-width: 1280px) {
  .card-material .card-material-content .card-material-body-content .content-form {
